...
const activeFilterModesPayload = computed(() => {
    ...
    Object.keys(activeFiltersPayload.value).forEach((key) => {
        modes[key] =
            filterModes.value[key] ?? defaultFilterMode(filterTypes.value[key]);
    });
...
const clientRows = computed(() => {
    ...
    rows = rows.filter((row) => {
        return Object.keys(activeFiltersPayload.value).every((field) => {
            ...
            return rowMatchesFilter(row[field], mode, type, filterValue);
        });
    });
...
function buildRequestPayload(pageOverride = null) {
    ...
    const params = {
        ...
        [props.paramMap.filters]: activeFiltersPayload.value,
        [props.paramMap.filterModes]: activeFilterModesPayload.value,
        [props.paramMap.filterTypes]: activeFilterTypesPayload.value,
...
function utilityColumnStyle(type, isHeader = false) {
    if (!localHorizontalScroll.value) {
        return null;
    }
    ...
    return {
        ...
        backgroundColor: isHeader ? 'rgb(248 250 252)' : 'inherit',
    };
}
...
function bodyColumnStyle(column, columnIndex) {
    const width = getColumnWidth(column.key);
    const baseStyle = {
        width: `${width}px`,
        minWidth: `${width}px`,
...
function cellStyleWithOverlay(row, column, rowIndex, colIndex) {
    ...
    if (isEditingCell(row, column)) {
        return {
            ...baseStyle,
            zIndex: Z_LAYERS.rowMenuOverlay + 5,
        };
    }
...
function createColumnStyle(column, columnIndex) {
    return bodyColumnStyle(column, columnIndex);
}
...
function updateFilterMode(columnKey, mode) {
        ...
        >
            ...
            <div class="ml-auto flex items-center gap-2">
                ...
                <div v-if="chartEnabled" class="relative">
                    ...
                    >
                        <i class="mdi mdi-chart-bar text-lg leading-none" />
                    </button>
                ...
                <div v-if="normalizedMenuItems.length" class="relative">
                    ...
                    >
                        <i class="mdi mdi-dots-vertical text-lg leading-none" />
                    </button>
                    ...
                    >
                        ...
                        >
                            <td
                                ...
                                :style="utilityColumnStyle('checkbox')"
                            />
                            ...
                            >
                                ...
                                <template v-if="isEditingCell(row, column)">
                                    ...
                                    <input
                                        ...
                                        "
                                        :style="
                                            editColumnInputStyle(row, column)
                                        "
                                        @input="
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    v-for="(
                                                        label, idx
                                                    ) in multiSelectionVisibleLabels(
                                                        column,
                                                        row,
                                                    )"
                                                    :key="`multi-chip-${idx}`"
